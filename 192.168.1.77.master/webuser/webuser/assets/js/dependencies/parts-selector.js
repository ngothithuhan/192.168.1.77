...
$(function() {
  ...
  $.fn.partsSelector = function( options ) {
    ...
    //remove all items
    $(this).on('click', '.movetoALL.parts', function() {
      var $i = $(this).closest('.parts-selector');
      var $c = $($i).find('.selected.list li.selected').length;


        // move items to parts list
        $($i).find('.parts.list ul').append($($i).find('.selected.list li').removeClass('selected').addClass('just moved').append( '<span class="context message">' + settings.removed + '</span>' ));
        removeMoved();
        $($i).removeClass('selected-selected');
        settings.callback.call(this);
    ...
    //add all items
    $(this).on('click', '.movetoALL.selected', function() {
      var $i = $(this).closest('.parts-selector');
      var $c = $($i).find('.parts.list li.selected').length;


        // move items to selected list
        $($i).find('.selected.list ul').append($($i).find('.parts.list li').removeClass('selected').addClass('just moved').append( '<span class="context message">' + settings.added + '</span>' ));
        removeMoved();
        $($i).removeClass('parts-selected');
        settings.callback.call(this);
