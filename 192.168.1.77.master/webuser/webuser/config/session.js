...
module.exports.session = {
  ...
  ***************************************************************************/
  ...
  cookie: {
    maxAge: 4 * 60 * 60 * 1000, // setting 4h logout
  },
  ...
  ***************************************************************************/
  ...
  // pass: require('./env').REDIS_PASS,
  // port: require('./env').REDIS_PORT,
  // db: 1,
  // prefix: 'sess:',
  adapter: "connect-redis",
  client: new Redis({
            sentinels: require('./env').REDIS_SENTINEL,
            name: require('./env').REDIS_NAME, // name of the sentinel master
            password: require('./env').REDIS_PASS,
            db: 1,
      }),
  prefix: 'sess:',
  ...
  ***************************************************************************/
  ...
  // url: 'mongodb://localhost:27017/FUNDSERV', // user, password and port optional
