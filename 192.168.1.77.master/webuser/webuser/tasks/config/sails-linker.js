  ...
  grunt.config.set('sails-linker', {
    devJs: {
      options: {
        startTag: '<!--SCRIPTS-->',
        endTag: '<!--SCRIPTS END-->',
        fileTmpl: '<script src="%s?v=' + getTime() + '"></script>',
        appRoot: '.tmp/public'
      },
      files: {
    ...
    devStyles: {
      options: {
        startTag: '<!--STYLES-->',
        endTag: '<!--STYLES END-->',
        fileTmpl: '<link rel="stylesheet" href="%s?v=' + getTime() + '">',
        appRoot: '.tmp/public'
      },
    ...
    devTpl: {
      options: {
        ...
        fileTmpl: '<script type="text/javascript" src="%s?v=' + getTime() + '"></script>',
        appRoot: '.tmp/public'
      },
      files: {
    ...
    devJsJade: {
      options: {
        startTag: '// SCRIPTS',
        endTag: '// SCRIPTS END',
        fileTmpl: 'script(src="%s?v=' + getTime() + '")',
        appRoot: '.tmp/public'
      },
      files: {
    ...
    devTplJade: {
      options: {
        startTag: '// TEMPLATES',
        endTag: '// TEMPLATES END',
        fileTmpl: 'script(type="text/javascript", src="%s?v=' + getTime() + '")',
        appRoot: '.tmp/public'
      },
      files: {
