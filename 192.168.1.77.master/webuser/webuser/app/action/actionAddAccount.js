...
function setUserKeyOTP(keyOTP) {
  return { type: "SET_USER_KEY_OTP", keyOTP }
}
module.exports = {
  showModalAddAccount, showModalEditAccount,
  closeModalAddAccount, showModalViewAcount, deleteModalAddAccount,
  setUserKeyOTP,
};
