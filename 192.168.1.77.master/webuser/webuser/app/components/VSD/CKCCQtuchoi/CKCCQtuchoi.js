...
import TableCKCCQtuchoi from './components/TableCKCCQtuchoi'
import ModalDetailCKCCQtuchoi_info from './components/ModalDetailCKCCQtuchoi_info'

class CKCCQtuchoi extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableCKCCQtuchoi datapage={datapage}
...
const decorators = flow([
    ...
    translate('CKCCQtuchoi')
]);

module.exports = decorators(CKCCQtuchoi);
