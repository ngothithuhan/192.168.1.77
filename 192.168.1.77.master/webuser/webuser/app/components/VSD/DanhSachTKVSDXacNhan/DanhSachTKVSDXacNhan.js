...
import TableTKGD_VSDXacNhan1 from './components/TableTKGD_VSDXacNhan'
import ModalDetailTKGD_VSDXacNhan_info1 from './components/ModalDetailTKGD_VSDXacNhan_info'

class DanhSachTKVSDXacNhan extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableTKGD_VSDXacNhan1 datapage={datapage}
...
const decorators = flow([
    ...
    translate('DanhSachTKVSDXacNhan')
]);

module.exports = decorators(DanhSachTKVSDXacNhan);
