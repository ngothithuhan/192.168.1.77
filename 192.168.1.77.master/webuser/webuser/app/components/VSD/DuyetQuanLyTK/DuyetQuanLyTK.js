...
import TableDuyetQLTK from './components/TableDuyetQLTK'
import ModalDuyetQLTK from './components/ModalDuyetQLTK'
import { connect } from 'react-redux'
class DuyetQuanLyTK extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableDuyetQLTK OBJNAME={datapage.OBJNAME} datapage={datapage}
            showModalDetail={this.showModalDetail.bind(this)}
            loadgrid={this.state.loadgrid} 
            isLoad= {this.state.isLoad}/>
          <ModalDuyetQLTK createSuccess={this.createSuccess.bind(this)}
...
const decorators = flow([
  ...
  translate('DuyetQuanLyTK')
]);

module.exports = decorators(DuyetQuanLyTK);
