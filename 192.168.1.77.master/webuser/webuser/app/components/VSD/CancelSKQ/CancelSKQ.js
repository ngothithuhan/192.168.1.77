...
import TableCancelSKQ from './components/TableCancelSKQ'
import ModalDetailCancelSKQ from './components/ModalDetailCancelSKQ'

class CancelSKQ extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableCancelSKQ datapage={datapage}
...
module.exports = decorators(CancelSKQ);
