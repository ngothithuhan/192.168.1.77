...
class TableCancelSKQ extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/fund/getlistcamastcancel', { data }).then((resData) => {
...
const decorators = flow([
    ...
    translate('TableCancelSKQ')
]);

module.exports = decorators(TableCancelSKQ);
