...
import TableDuKienKhop from './components/TableDuKienKhop.js'
import ModalDuKienKhop from './components/ModalDuKienKhop.js'

class DuKienKhop extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableDuKienKhop OBJNAME={datapage.OBJNAME} datapage={datapage}
                        showModalDetail={this.showModalDetail.bind(this)}
                    />
                    <ModalDuKienKhop createSuccess={this.createSuccess.bind(this)}
...
const decorators = flow([
    ...
    translate('DuKienKhop')
]);

module.exports = decorators(DuKienKhop);
