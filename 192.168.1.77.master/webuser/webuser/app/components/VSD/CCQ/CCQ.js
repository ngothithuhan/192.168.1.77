...
import TableCloseCCQ from './components/TableCloseCCQ'
import ModalDetailCCQ_Close from './components/ModalDetailCCQ_Close'

class CCQ extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableCloseCCQ datapage={datapage}
