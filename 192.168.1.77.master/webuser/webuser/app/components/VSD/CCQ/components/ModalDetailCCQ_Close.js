...
class ModalDetailCCQ_Close extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    async submitGroup() {
        var api = '/account/req_close_account';
                        ...
                        <div className="add-info-account">
                            <div className={this.state.access=="view"?"col-md-12 disable":"col-md-12"} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-3">
                                        <NumberFormat disabled={displayy} className="form-control" id="lblTransactionvfmcode" thousandSeparator={true} prefix={''} placeholder={this.props.strings.transactionvfmcode} value={this.state.datagroup["p_trade"]==0?0:this.state.datagroup["p_trade"]} decimalScale={2} disabled={true}/>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-3">
                                        <NumberFormat className="form-control" id="lblTtbtwait" thousandSeparator={true} prefix={''} placeholder={this.props.strings.ttbtwait} value={this.state.datagroup["p_sramt"]} decimalScale={2} disabled={true}/>
...
const decorators = flow([
    ...
    translate('ModalDetailCCQ_Close')
]);
module.exports = decorators(ModalDetailCCQ_Close);
