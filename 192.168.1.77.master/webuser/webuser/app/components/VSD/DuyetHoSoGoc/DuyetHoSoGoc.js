...
import TableDuyetHoSoGoc from './components/TableDuyetHoSoGoc'
import ModalDuyetHoSoGoc from './components/ModalDuyetHoSoGoc'
import { connect } from 'react-redux'
class DuyetHoSoGoc extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableDuyetHoSoGoc OBJNAME={datapage.OBJNAME} datapage={datapage}
            showModalDetail={this.showModalDetail.bind(this)}
            loadgrid={this.state.loadgrid} 
            isLoad= {this.state.isLoad}/>
          <ModalDuyetHoSoGoc createSuccess={this.createSuccess.bind(this)}
...
const decorators = flow([
  ...
  translate('DuyetHoSoGoc')
]);

module.exports = decorators(DuyetHoSoGoc);
