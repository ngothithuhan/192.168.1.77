...
import TableGhiNhanLenhDaTT from './components/TableGhiNhanLenhDaTT'
import ModalDetailTableGhiNhanLenhDaTT from './components/ModalDetailTableGhiNhanLenhDaTT'

class GhiNhanLenhDaTT extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
const stateToProps = state => ({
  ...
  const decorators = flow([
    ...
    translate('GhiNhanLenhDaTT')
  ]);

  module.exports = decorators(GhiNhanLenhDaTT);
