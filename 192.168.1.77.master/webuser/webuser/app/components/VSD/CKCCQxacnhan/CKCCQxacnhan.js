...
import TableCKCCQxacnhan from './components/TableCKCCQxacnhan'
import ModalDetailCKCCQxacnhan_info from './components/ModalDetailCKCCQxacnhan_info'

class CKCCQxacnhan extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableCKCCQxacnhan datapage={datapage}
...
const decorators = flow([
    ...
    translate('CKCCQxacnhan')
]);

module.exports = decorators(CKCCQxacnhan);
