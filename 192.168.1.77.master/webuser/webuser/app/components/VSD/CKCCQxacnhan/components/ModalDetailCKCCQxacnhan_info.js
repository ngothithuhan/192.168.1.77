...
class ModalDetailCKCCQxacnhan_info extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            if (nextProps.isClear) {
                ...
                this.setState({
                    ...
                    TRFTYPEDESC:nextProps.DATA[getExtensionByLang("TRFTYPEDESC",this.props.lang)]
                })
            }
        }
        else
    ...
    async submitGroup() {
            ...
            var api = '/fund/setranfer_confirm';
                        ...
                        <div className="add-info-account">
                            <div className={this.state.access=="view"?"col-md-12 disable":"col-md-12"} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-9">
                                        <label className="form-control" id="lbltransfertype">{this.state["TRFTYPEDESC"]}</label>
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-3">
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-9">
                                        <label className="form-control" id="lblDistributorname">{this.state.datagroup["p_rcvmbcode"]}</label>
...
const decorators = flow([
    ...
    translate('ModalDetailCKCCQxacnhan_info')
]);

module.exports = decorators(ModalDetailCKCCQxacnhan_info);
