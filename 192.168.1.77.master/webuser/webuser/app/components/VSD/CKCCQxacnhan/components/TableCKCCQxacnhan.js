...
class TableCKCCQxacnhan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
                ...
                <div className="col-md-12" >
                    <ReactTable
                        columns={[
                            ...
                            {
                                Header: props => <div className="wordwrap" id="lblvfmcode">{this.props.strings.SYMBOL}</div>,
                                id: "SYMBOL",
                                accessor: "SYMBOL",
                                width: 100,
                                Cell: ({ value }) => (
                            ...
                            {
                                Header: props => <div className="wordwrap" id="lbltransfertype">{this.props.strings[getExtensionByLang("TRFTYPEDESC", this.props.lang)]}</div>,
                                // id: "TRFTYPEDESC",
...
TableCKCCQxacnhan.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableCKCCQxacnhan')
]);

module.exports = decorators(TableCKCCQxacnhan);
