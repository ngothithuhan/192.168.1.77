...
class ModalManagerUploadOriginalOrder extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showModal: false,
                    ...
                    <div className="">
                        <div className="col-xs-12">
                            <div className="container panel panel-success col-xs-12 pdl-0 pdr-0">
                                ...
                                <div className="col-xs-6">
                                    <h5 className="col-xs-4"><b>{strings.username}</b></h5>
                                    <div className="col-xs-8">
                                        <label className="form-control txtInput28" disabled >{DTUploadDetail.USERNAME} </label>
                                    </div>
                                </div>
                                <div className="col-xs-6">
                                    <h5 className="col-xs-4"><b>{strings.statusdownload}</b></h5>
                                    <div className="col-xs-8">
                                        <label className="form-control txtInput28" disabled >{DTUploadDetail.STATUSDOWNLOADDESC} </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {ACTION == "EDIT" ?
                            ...
                            <div className="col-md-12 pdt-5 dl-0 pdr-0">
                                <div className={"col-md-12 pdl-0 pdr-0"}>
                                    {!isPDFFile ?
                                        <div className="imgPreview" style={{ cursor: 'pointer', textAlign: 'center' }} onClick={() => this.setState({ isOpenOldSignimg: true })}>
                                            <img src={IMGbase64} className="imgUpload" />
                                            {this.state.isOpenOldSignimg && (
                                                <Lightbox
                                                    mainSrc={IMGbase64}
                                                    onCloseRequest={() => this.setState({ isOpenOldSignimg: false })}
                                                    reactModalStyle={{ overlay: { zIndex: 10000 } }}
                                                />)
                                            }
                                        </div>
                                        :
                                        <iframe src={IMGbase64} className="imgUpload-pdf-view-full "></iframe>
                                    }
...
ModalManagerUploadOriginalOrder.defaultProps = {
    strings: {
...
const decorators = flow([
    ...
    translate('ModalManagerUploadOriginalOrder')
]);
module.exports = decorators(ModalManagerUploadOriginalOrder);
