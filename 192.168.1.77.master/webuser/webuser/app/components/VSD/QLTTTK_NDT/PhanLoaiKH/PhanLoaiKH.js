...
import TablePLKH from './components/TablePLKH'
import ModalDetailPhanLoaiKH_info from './components/ModalDetailPhanLoaiKH_info'

class PhanLoaiKH extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
const decorators = flow([
    ...
    translate('PhanLoaiKH')
]);

module.exports = decorators(PhanLoaiKH);
