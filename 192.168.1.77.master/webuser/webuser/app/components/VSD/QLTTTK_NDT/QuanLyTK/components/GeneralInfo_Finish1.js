...
class GeneralInfo_Finish extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <div className={this.props.access !== "view" ? "col-md-12 row" : "col-md-12 row disable"}>
                    {isCustom && <div className="col-md-12 row">{this.props.strings.confirmNote}</div>}
                    {isCustom && <div className="col-md-12 row">{this.props.strings.lableSentPhone} {this.props.GeneralInfoMain["MOBILE"]} {this.props.strings.andEmail} {this.props.GeneralInfoMain["EMAIL"]}</div>}
                    {(!isAdmin || createAcc) && <div className="col-md-12 row"><div className="col-md-4 row"><div onClick={this.props.getCaptcha} style={{ cursor: "pointer" }} dangerouslySetInnerHTML={{ __html: this.state.imgCaptcha }} /></div></div>}
                    {(!isAdmin || createAcc) && <div className="col-md-12 row">
                        <div className="col-md-2 row">
                            <input id="txtFinishCaptcha" className="form-control" type="text" onChange={this.onChange.bind(this, "CAPTCHA")} />
                        </div>
                        <div className="col-md-4 " >
                            <input id="btnFinishSentOTP" type="button" onClick={this.submit} className="btn btn-primary" style={{ marginLeft: 0, marginRight: 5 }} value={this.props.strings.sentOTP} />
                        </div>
                    </div>}
                    {/*
                ...
                <div className="col-md-12 row">
                    <div className="pull-right">
                        <input id="btnFinishPrev" type="button" onClick={this.previousPage} className="btn btn-primary" style={{ marginLeft: 0, marginRight: 5 }} value={this.props.strings.back} />
