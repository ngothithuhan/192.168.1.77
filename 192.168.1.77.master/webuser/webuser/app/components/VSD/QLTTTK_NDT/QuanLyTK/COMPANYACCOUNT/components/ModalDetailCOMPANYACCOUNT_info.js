...
class ModalDetailCOMPANYACCOUNT_info extends Component {
    constructor(props) {
        super(props);
        this.state = {
            access: 'ADD',
    ...
    submitGroup() {
        ...
        if (mssgerr == '') {
            ...
            var api = '/account/prc_company_account';
            var obj = {
    ...
    refresh() {
        ...
        this.setState({ datagroup, CUSTODYCD, DESCRIPTION, autoid, access })
    }
    onChange(type, e) {
        if (e) {
            ...
            if (type == "CUSTODYCD") {
                ...
                this.setState({ CUSTODYCD: e, datagroup });
            }
            else
                if (type == "IDTYPE") {
    ...
    render() {
        ...
        // console.log("render=================2==", ISCUSTODYCD, this.state.datagroup, this.state.CUSTODYCD)
        return (
            <Modal show={this.props.showModalDetail} >
                ...
                <Modal.Body style={{ overflow: "auto", height: "100%" }}>
                    <div className="panel-body COMPANYaccount">
...
const decorators = flow([
    ...
    translate('ModalDetailCOMPANYACCOUNT_info')
]);
module.exports = decorators(ModalDetailCOMPANYACCOUNT_info);
