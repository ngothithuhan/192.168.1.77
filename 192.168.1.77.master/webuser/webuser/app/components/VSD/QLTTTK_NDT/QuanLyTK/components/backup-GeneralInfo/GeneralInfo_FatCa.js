...
class GeneralInfo_FatCa extends React.Component {
    ...
    componentDidMount() {
        ...
        if ( (!this.props.GeneralInfoMain.ISFATCA || this.props.GeneralInfoMain.ISFATCA == 'N') && this.props.GeneralInfoMain.COUNTRY != '229') {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <div className={this.props.access !== "view" ? "col-md-12 modal-fatca" : "col-md-12 modal-fatca disable"}>
                    <div className="col-md-5 nav-popup-left">
                        <div className="row">
                            <div className="col-md-8 " onMouseOver={this.handleMouseIn1.bind(this)} onMouseOut={this.handleMouseOut1.bind(this)}>{this.props.strings.iisuscitizensus}</div>
                            ...
                            {ISVIE ? <div className="row col-md-12" style={tooltipStyle1}>
                            <div  style={tooltipStyle1}>Nếu tích chọn, vui lòng khai mẫu W-9</div>
                            </div> :
                            <div className="row col-md-12" style={tooltipStyle1}>
                            <div   style={tooltipStyle1}>If ticked, please obtain W-9</div>
                            </div>}
                        <div className="clearfix"></div>
                        <div className="row">
                            <div className="col-md-8 hight-light" onMouseOver={this.handleMouseIn2.bind(this)} onMouseOut={this.handleMouseOut2.bind(this)}>{this.props.strings.isusplaceofbirth}</div>
                        ...
                        {ISVIE ? <div className="row col-md-12" style={tooltipStyle2}>
                            <div  style={tooltipStyle2}>Nếu tích chọn, vui lòng khai mẫu W-9 hoặc W-8BEN và hộ chiếu, giấy tờ tương đương chứng nhận là công dân nước ngoài và giải trình bằng văn bản liên quan đến công dân Mỹ</div>
                            </div> :
                            <div className="row col-md-12" style={tooltipStyle2}>
                            <div   style={tooltipStyle2}>If ticked, please obtain W-9 or W-8BEN and Non-US passport or similar documentation establishing foreign citizenship and written explanation regarding US citizenship.</div>
                            </div>}
                        <div className="clearfix"></div>
                        <div className="row">
                            <div className="col-md-8 " onMouseOver={this.handleMouseIn3.bind(this)} onMouseOut={this.handleMouseOut3.bind(this)}>{this.props.strings.isusmail}</div>
                        ...
                        <div className="clearfix"></div>
                        <div className="row">
                            <div className="col-md-8" onMouseOver={this.handleMouseIn3.bind(this)} onMouseOut={this.handleMouseOut3.bind(this)}>{this.props.strings.isusphone}</div>
                        ...
                        <div className="clearfix"></div>
                        <div className="row">
                            <div className="col-md-8" onMouseOver={this.handleMouseIn3.bind(this)} onMouseOut={this.handleMouseOut3.bind(this)}>{this.props.strings.isustranfer}</div>
                        ...
                        <div className="clearfix"></div>
                        <div className="row">
                            <div className="col-md-8 " onMouseOver={this.handleMouseIn3.bind(this)} onMouseOut={this.handleMouseOut3.bind(this)}>{this.props.strings.isauthrigh}</div>
                        ...
                        <div className="clearfix"></div>
                        <div className="row">
                            <div className="col-md-8" onMouseOver={this.handleMouseIn3.bind(this)} onMouseOut={this.handleMouseOut3.bind(this)}>{this.props.strings.issoleaddress}</div>
                            ...
                            {ISVIE ? <div className="row col-md-12" style={tooltipStyle3}>
                            <div  style={tooltipStyle3}>Nếu tích chọn tại bất cứ mục 3,4,5,6,7, vui lòng khai mẫu W-9 hoặc W-8BEN và hộ chiếu, giấy tờ tương đương chứng nhận không phải là công dân Mỹ</div>
                            </div> :
                            <div className="row col-md-12" style={tooltipStyle3}>
                            <div   style={tooltipStyle3}>If ticked in any 3,4,5,6,7; please obtain W-9 or W-8BEN and Non-US passport and Documentary evidence establishing non US status.</div>
                            </div>}
                        {/* <div className="clearfix"></div>
                        <div className="row">
                    ...
                    <div style={{}} className="col-md-7 nav-popup-right">
                        <div 
                        // className={this.state.info_fatca["ISUSCITIZEN"] == "Y" ? "" : "disable"} 
                        >
                            <div className="col-md-12" style={{ border: "1px solid #ddd" }}>

                                <div className="row">
                                    <div style={{ paddingBottom: "5px" }} className="row">
                                        <div className="col-md-6">{this.props.strings.w9orw8ben}</div>
                                        <div style={{ paddingLeft: "2px" }} className="col-md-5">
                                        ...
                                        {/* <input type="text" onChange={this.onChange.bind(this,"W9ORW8BEN")} className="form-control" /> */}
                                    </div>
                                    <div style={{ paddingBottom: "5px" }} className="row">
                                        <div className="col-md-6">{this.props.strings.signdate}</div>
                                        {/* <DatePicker
                            dateFormat="DD/MM/YYYY" className="form-control"
                              selected={this.state.date.REGISTER}

                              onChange={this.onChange.bind(this,'REGISTER')}
                          /> */}
                                        <div className="col-md-6 fixWidthDatePickerForOthers" style={{ paddingLeft: 5 }}>
                                            <DateInput id="txtSigndate" onChange={this.onChange.bind(this)} value={this.state.info_fatca.SIGNDATE} type="SIGNDATE" />
                                        </div>
                                    </div>
                                    <div style={{ paddingBottom: "5px" }} className="row">
                                        <div className="col-md-6">{this.props.strings.reopndate}</div>
                                        {/* <DatePicker
                        dateFormat="DD/MM/YYYY" className="form-control"
                          selected={this.state.date.REOPNDATE}

                          onChange={this.onChange.bind(this,'REOPNDATE')}
                      /> */}
                                        <div className="col-md-6 fixWidthDatePickerForOthers" style={{ paddingLeft: 5 }}>
                            ...
                            <div className="col-md-12" style={{ border: "1px solid #ddd" }}>
                                ...
                                {/* <div className="row" style={{ border: "1px solid #ddd" }}> */}
                                    <div className="row" style={{ paddingTop: "5px", paddingBottom: "5px" }}>
                                        <div className="col-md-6">{this.props.strings.isus}</div>
                                    ...
                                    <div className="row">
                            <div className="col-md-6">{this.props.strings.isdisagree} </div>
                ...
                <div className="col-md-12 row">
                    <div className="pull-right">
                        <input id="btnFatcaPrev" type="button" onClick={this.previousPage} className="btn btn-primary" style={{ marginLeft: 0, marginRight: 5 }} value={this.props.strings.prev} />
                        <input id="btnFatcaSubmit" type="button" onClick={this.onSubmit} className="btn btn-primary" style={{ marginRight: 15 }} value={this.props.strings.next} />
