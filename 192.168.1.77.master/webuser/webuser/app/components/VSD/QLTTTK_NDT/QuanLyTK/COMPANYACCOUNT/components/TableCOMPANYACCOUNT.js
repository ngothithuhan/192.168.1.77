...
class TableCOMPANYACCOUNT extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    onRowClick(state, rowInfo, column, instance) {
        ...
        return {
            ...
            //     // IMPORTANT! React-Table uses onClick COMPANYly to trigger
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/account/prc_get_company_account', { data }).then((resData) => {
        ...
        if (this.state.selectedRows.size > 0) {
            this.state.selectedRows.forEach((key, value, set) => {
                ...
                new Promise((resolve, reject) => {
                    ...
                    resolve(RestfulUtils.posttrans('/account/prc_company_account', datadelete)
                        .then(res => {
                            i += 1
...
TableCOMPANYACCOUNT.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableCOMPANYACCOUNT')
]);

module.exports = decorators(TableCOMPANYACCOUNT);
