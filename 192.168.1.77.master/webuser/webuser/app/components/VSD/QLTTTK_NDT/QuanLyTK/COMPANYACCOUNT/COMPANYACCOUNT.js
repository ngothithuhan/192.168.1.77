...
import TableCOMPANYACCOUNT from './components/TableCOMPANYACCOUNT'
import ModalDetailCOMPANYACCOUNT_info from './components/ModalDetailCOMPANYACCOUNT_info'
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableCOMPANYACCOUNT datapage={datapage}
            showModalDetail={this.showModalDetail.bind(this)}
            loadgrid={this.state.loadgrid}
            isrefresh={this.state.isrefresh}
            OBJNAME="COMPANYACCOUNT" />
        </div>
        <ModalDetailCOMPANYACCOUNT_info ISFIRSTLOAD={this.state.ISFIRSTLOAD} change_ISFIRSTLOAD={this.change_ISFIRSTLOAD.bind(this)} createSuccess={this.createSuccess.bind(this)}
...
module.exports = decorators(COMPANYACCOUNT);
