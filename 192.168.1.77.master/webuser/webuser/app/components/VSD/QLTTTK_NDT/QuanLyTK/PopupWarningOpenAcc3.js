...
import './PopupWarningOpenAcc3.scss';

class PopupWarningOpenAcc3 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            tmtxnum: ''
...
const decorators = flow([
    ...
    translate('PopupWarningOpenAcc3')
]);
module.exports = decorators(PopupWarningOpenAcc3);
