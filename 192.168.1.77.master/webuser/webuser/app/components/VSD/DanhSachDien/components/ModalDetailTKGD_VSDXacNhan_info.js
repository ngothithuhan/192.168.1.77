...
class ModalDetailTKGD_VSDXacNhan_info1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
const decorators = flow([
    ...
    translate('ModalDetailTKGD_VSDXacNhan_info1')
]);

module.exports = decorators(ModalDetailTKGD_VSDXacNhan_info1);
