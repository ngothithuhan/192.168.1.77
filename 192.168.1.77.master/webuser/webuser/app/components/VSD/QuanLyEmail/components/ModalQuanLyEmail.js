...
class ModalQuanLyEmail extends Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <div className="add-info-account">
                            ...
                            <div className="col-md-12 row">
                                ...
                                <div className="col-md-9">
                                    <label className="form-control"> {this.state.p_subject} </label>
                                </div>
                            </div>
                            <div className="col-md-12 row">
                                <div className="col-md-3">
...
const decorators = flow([
    ...
    translate('ModalQuanLyEmail')
]);
module.exports = decorators(ModalQuanLyEmail);
