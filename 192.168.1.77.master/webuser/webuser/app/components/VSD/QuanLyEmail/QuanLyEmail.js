...
import ModalQuanLyEmail from './components/ModalQuanLyEmail';
import TableQuanLyEmail from './components/TableQuanLyEmail'
import { connect } from 'react-redux'
class QuanLyEmail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('QuanLyEmail')
]);

module.exports = decorators(QuanLyEmail);
