...
class TableTKGD_VSDXacNhan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/fund/getlistvsdstatus', { data }).then((resData) => {
                ...
                <div className="col-md-12" >
                    <ReactTable
                        columns={[
                            ...
                            {
                                Header: props => <div className="wordwrap" id="lblVSDSTATUS">{this.props.strings.VSDSTATUS}</div>,
                                id: "VSDSTATUS_DESC",
...
TableTKGD_VSDXacNhan.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableTKGD_VSDXacNhan')
]);

module.exports = decorators(TableTKGD_VSDXacNhan);
