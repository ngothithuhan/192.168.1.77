...
class TableAddCreateThongtinNAV extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/fund/getlistnav', { data }).then((resData) => {
...
TableAddCreateThongtinNAV.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableAddCreateThongtinNAV')
]);

module.exports = decorators(TableAddCreateThongtinNAV);
