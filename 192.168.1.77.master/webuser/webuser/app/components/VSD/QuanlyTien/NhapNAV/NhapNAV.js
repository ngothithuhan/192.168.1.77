...
import ModalDetailNhapNAV from './components/ModalDetailNhapNAV'
import TableAddCreateThongtinNAV from './components/TableAddCreateThongtinNAV'
import { connect } from 'react-redux'
class NhapNAV extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableAddCreateThongtinNAV datapage={datapage}
...
module.exports = decorators(NhapNAV);
