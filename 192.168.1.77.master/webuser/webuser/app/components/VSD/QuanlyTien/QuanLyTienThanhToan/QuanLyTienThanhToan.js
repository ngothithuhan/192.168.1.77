...
import TableTienThanhToan from './components/TableTienThanhToan'
import { connect } from 'react-redux'
class QuanLyTienThanhToan extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableTienThanhToan datapage={datapage}
...
QuanLyTienThanhToan.defaultProps = {
  strings: {
    title: 'Quản lý lệnh tiền thanh toán nhận từ MBBank'
  },
};
...
const decorators = flow([
  ...
  translate('QuanLyTienThanhToan')
]);

module.exports = decorators(QuanLyTienThanhToan);
