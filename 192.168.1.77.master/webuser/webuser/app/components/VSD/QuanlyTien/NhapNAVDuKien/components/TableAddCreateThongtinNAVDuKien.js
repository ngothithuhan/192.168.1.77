...
class TableAddCreateThongtinNAVDuKien extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/fund/getlistexpectnav', { data }).then((resData) => {
            ...
            <div>
                ...
                <div className="col-md-12" >
                    <ReactTable
                        ...
                        {
                            Header: props => <div className="wordwrap" id="lblNGUOINHAP">{this.props.strings.TLNAME}</div>,
                            id: "TLNAME",
                            accessor: "TLNAME",
                            width: 146,
                            Cell: ({ value }) => (
                        ...
                        {
                            Header: props => <div className="wordwrap" id="lblsession">{this.props.strings.TRADINGID}</div>,
                            id: "TRADINGID",
                            accessor: "TRADINGID",
                            width: 150,
                            Cell: ({ value }) => (
                        ...
                        {
                            Header: props => <div className="wordwrap" id="lblALLOCDATE">{this.props.strings.ALLOCDATE}</div>,
                            id: "ALLOCDATE",
                            accessor: "ALLOCDATE",
                            width: 155,
                            Cell: ({ value }) => (
                        ...
                        // {
                        //     Header: props => <div className="wordwrap" id="lblNOTE">{this.props.strings.TXDESC}</div>,
                        //     id: "TXDESC",
                        //     accessor: "TXDESC",
                        //     width: 167,
                        //     Cell: ({ value }) => (
...
TableAddCreateThongtinNAVDuKien.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableAddCreateThongtinNAVDuKien')
]);

module.exports = decorators(TableAddCreateThongtinNAVDuKien);
