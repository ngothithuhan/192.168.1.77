...
class TableAddCreateThongtinPhiCuoiThang extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/fund/getlistfeecuoithang', { data }).then((resData) => {
            ...
            <div>
                ...
                <div className="col-md-12" >
                    <ReactTable
                        ...
                        {
                            Header: props => <div className="wordwrap" id="lblENDMONTHFEE">{this.props.strings.ENDMONTHFEE}</div>,
                            id: "ENDMONTHFEE",
                            accessor: "ENDMONTHFEE",
                            width: 130,
                            Cell: ({ value }) => (
...
TableAddCreateThongtinPhiCuoiThang.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableAddCreateThongtinPhiCuoiThang')
]);

module.exports = decorators(TableAddCreateThongtinPhiCuoiThang);
