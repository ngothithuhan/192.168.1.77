...
class ModalNhapPhiCuoiThang extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
            ...
            checkFields: [
                ...
                { name: "ENDMONTHFEE", id: "ENDMONTHFEE" },
            ],
        };
    }
    ...
    submitGroup = () => {
        ...
        console.log('this.state.ENDMONTHFEE:', this.state.ENDMONTHFEE);
        var mssgerr = '';
        ...
        if (mssgerr == '') {
            var api = this.props.access == "update" ? '/fund/update_endmonthfee':'/fund/insert_endmonthfee';
            ...
            RestfulUtils.posttrans(api, {
                ...
                p_endmonthfee: this.state.ENDMONTHFEE,
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            if (nextProps.isClear) {
                ...
                this.setState({
                    ...
                    ENDMONTHFEE: nextProps.DATA.ENDMONTHFEE,
                    ...
                    <div className="panel-body ">
                        <div className="add-info-account">
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className="highlight"><b>{this.props.strings.ENDMONTHFEE}</b></h5>
                                    </div>
                                    <div className="col-md-8 ">
                                        <NumberFormat maxLength={20}
                                            className="form-control" id="txtENDMONTHFEE"
                                            onValueChange={this.onValueChange.bind(this, 'ENDMONTHFEE')}
                                            thousandSeparator={true} prefix={''}
                                            placeholder={this.props.strings.ENDMONTHFEE} value={this.state.ENDMONTHFEE}
                                            decimalScale={2} allowNegative={false} />
                                        {/* <input
                                    value={this.state.ENDMONTHFEE}
                                    onChange={this.onChange.bind(this, "ENDMONTHFEE")}
                                    id="txtENDMONTHFEE"
                                    className="form-control"
                                    type="text"
                                    placeholder={this.props.strings.ENDMONTHFEE}

                                /> */}
                                        {/* <label className="form-control" id="txtfullname" >{this.state.ENDMONTHFEE}</label> */}
                                    </div>
                                </div>

                                {/* <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className="highlight"><b>{this.props.strings.ENDMONTHFEEAMOUNT}</b></h5>
                                    </div>
                                    <div className="col-md-8 ">
                                        <NumberFormat maxLength={20}
                                            className="form-control" id="ENDMONTHFEEAMOUNT"
                                            onValueChange={this.onValueChange.bind(this, 'ENDMONTHFEEAMOUNT')}
                                            thousandSeparator={true} prefix={''}
                                            placeholder={this.props.strings.ENDMONTHFEEAMOUNT} value={this.state.ENDMONTHFEEAMOUNT}
                                            decimalScale={2} allowNegative={false} />
...
ModalNhapPhiCuoiThang.defaultProps = {
...
const decorators = flow([
    ...
    translate('ModalNhapPhiCuoiThang')
]);

module.exports = decorators(ModalNhapPhiCuoiThang);
