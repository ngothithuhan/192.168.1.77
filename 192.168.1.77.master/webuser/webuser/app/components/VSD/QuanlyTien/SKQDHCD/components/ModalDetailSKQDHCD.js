...
class ModalDetailSKQDHCD extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    async submitGroup() {
        ...
        if (mssgerr == '') {
            ...
            var api = '/fund/addcamast';
            if (this.state.access == "update") {
                api = '/fund/updatecamast';
            }
                            ...
                            <div className={this.state.access == 'view' ? "col-md-12 disable" : "col-md-12"} style={{ paddingTop: "11px" }}>
                                ...
                                */}
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-8">
                                        <input disabled={displayy} className="form-control" type="text" placeholder={this.props.strings.isincode} id="txtIsincode" value={this.state.datagroup["p_isincode"]} onChange={this.onChange.bind(this, "p_isincode")} maxLength={20}/>
                                    </div>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-8">
                                        <input disabled={displayy} className="form-control" type="text" placeholder={this.props.strings.percentperform} id="txtPercentperform" value={this.state.datagroup["p_rate"]} onChange={this.onChange.bind(this, "p_rate")}  maxLength={20}/>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-8">
                                        <input disabled={displayy} className="form-control" type="text" placeholder={this.props.strings.desc} id="txtDesc" value={this.state.datagroup["p_description"]} onChange={this.onChange.bind(this, "p_description")}  maxLength={250}/>
                                    </div>
...
const decorators = flow([
    ...
    translate('ModalDetailSKQDHCD')
]);
module.exports = decorators(ModalDetailSKQDHCD);
