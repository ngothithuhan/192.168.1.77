...
import TableSKQDHCD from './components/TableSKQDHCD'
import ModalDetailSKQDHCD from './components/ModalDetailSKQDHCD'

class SKQDHCD extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return(
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableSKQDHCD OBJNAME={datapage.OBJNAME}  datapage={datapage}
...
const stateToProps = state => ({
  ...
  module.exports = decorators(SKQDHCD);
