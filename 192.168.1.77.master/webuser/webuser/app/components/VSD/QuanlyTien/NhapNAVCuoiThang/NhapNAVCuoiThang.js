...
import ModalNhapNAVCuoiThang from './components/ModalNhapNAVCuoiThang'
import TableAddCreateThongtinNAVCuoiThang from './components/TableAddCreateThongtinNAVCuoiThang'
import { connect } from 'react-redux'
class NhapNAVCuoiThang extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableAddCreateThongtinNAVCuoiThang datapage={datapage}
...
NhapNAVCuoiThang.defaultProps = {

  strings: {
    title: 'Thông tin NAV cuối tháng'
...
const decorators = flow([
  ...
  translate('NhapNAVCuoiThang')
]);

module.exports = decorators(NhapNAVCuoiThang);
