...
class ModalDetailTKGDDep_info extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            checkFields: [
                { name: "p_newcustodycd", id: "txtCustodycd" },
            ],
            isDone: true,
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            this.setState({
                ...
                datagroup: {
                    ...
                    p_newcustodycd: nextProps.DATA.CUSTODYCD,
        ...
        if (event.target) {
            ...
            if (type == 'p_custtype') {
                if (this.state.datagroup["p_grinvestor"] == 'NN') {
                    this.state.datagroup["p_idtype"] = '009'
    ...
    async submitGroup() {
        ...
        if (mssgerr == '') {
            var api = '/user/addcfmastvip';
            if (this.state.access == "update") {
                api = '/user/updatecfmastvip';
            }
            ...
            console.log("cfmastvip:",this.state.datagroup)
                            ...
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-5">
                                        <input maxLength={20} disabled={displayy} className="form-control" type="text" placeholder={this.props.strings.custodycd} id="txtCustodycd" value={this.state.datagroup["p_newcustodycd"]} onChange={this.onChange.bind(this, "p_newcustodycd")} />
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-9">
                                        <input maxLength={500} disabled={displayy} className="form-control" type="text" placeholder={this.props.strings.fullname} id="txtFullname" value={this.state.datagroup["p_fullname"]} onChange={this.onChange.bind(this, "p_fullname")} />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-3">
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-5">
                                        <DropdownFactory disabled={displayy} CDVAL={this.state.datagroup["p_custtype"]} onSetDefaultValue={this.onSetDefaultValue} onChange={this.onChange.bind(this)} value="p_custtype" CDTYPE="CF" CDNAME="CUSTTYPE" ID="drdCUSTTYPE" />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-3">
                                    ...
                                    <div className="col-md-5">
                                        <DropdownFactory isrefesh="true" disabled={displayy} CDVAL={this.state.datagroup["p_idtype"]} disabled={displayyIDTYPE} onSetDefaultValue={this.onSetDefaultValue} onChange={this.onChange.bind(this)} value="p_idtype" CDTYPE="CF" CDNAME={cdname} ID="drdIdtype" />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-3">
                                    ...
                                    <div className="col-md-5">
                                        <input maxLength={30} disabled={displayy} className="form-control" type="text" placeholder={this.props.strings.idcode} id="txtIdcode" value={this.state.datagroup["p_idcode"]} onChange={this.onChange.bind(this, "p_idcode")} />
                                    </div>
                                </div>
                                {/*
                                <div className="col-md-12 row">
