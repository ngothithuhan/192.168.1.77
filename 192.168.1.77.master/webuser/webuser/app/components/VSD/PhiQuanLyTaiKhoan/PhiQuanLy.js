...
import TablePhiQuanLy from './components/TablePhiQuanLy.js'
import ModalPhiQuanLy from './components/ModalPhiQuanLy.js'

class PhiQuanLy extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TablePhiQuanLy OBJNAME={datapage.OBJNAME} datapage={datapage}
                        showModalDetail={this.showModalDetail.bind(this)}
                    />
                    <ModalPhiQuanLy createSuccess={this.createSuccess.bind(this)}
...
module.exports = decorators(PhiQuanLy);
