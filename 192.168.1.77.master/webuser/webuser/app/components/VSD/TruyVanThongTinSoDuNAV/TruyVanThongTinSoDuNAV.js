...
import TableTruyVanThongTinSoDuNAV from './components/TableTruyVanThongTinSoDuNAV';

import RestfulUtils from 'app/utils/RestfulUtils';
import { connect } from 'react-redux'
class TruyVanThongTinSoDuNAV extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableTruyVanThongTinSoDuNAV datapage={datapage}
...
TruyVanThongTinSoDuNAV.defaultProps = {
    strings: {
    },
};
...
const decorators = flow([
    ...
    translate('TruyVanThongTinSoDuNAV')
]);
module.exports = decorators(TruyVanThongTinSoDuNAV);
