...
import TableBlockSKQ from './components/TableBlockSKQ'
import ModalDetailBlockSKQ from './components/ModalDetailBlockSKQ'

class BlockSKQ extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableBlockSKQ datapage={datapage}
...
module.exports = decorators(BlockSKQ);
