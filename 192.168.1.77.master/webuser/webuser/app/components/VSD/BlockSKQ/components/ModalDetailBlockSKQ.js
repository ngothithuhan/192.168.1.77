...
class ModalDetailBlockSKQ extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
                            ...
                            <div className={this.state.access == 'view' ? "col-md-12 disable" : "col-md-12"} style={{ paddingTop: "11px" }}>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className=""><b>{this.props.strings.righttype}</b></h5>
                                    </div>
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className=""><b>{this.props.strings.vfmcode}</b></h5>
                                    </div>
                                ...
                                */}
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className=""><b>{this.props.strings.lastdayregister}</b></h5>
                                    </div>
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className=""><b>{this.props.strings.dayperform}</b></h5>
                                    </div>
                                    <div className="col-md-8 fixWidthDatePickerForOthers">
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className=""><b>{this.props.strings.percentperform}</b></h5>
                                    </div>
                                    <div className="col-md-8">
...
const decorators = flow([
    ...
    translate('ModalDetailBlockSKQ')
]);
module.exports = decorators(ModalDetailBlockSKQ);
