...
class TableMix extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    search(keySearch) {
        ...
        RestfulUtils.post('/fund/getlisportfolio', { keySearch, type: '5', OBJNAME: this.props.OBJNAME })
            .then(resData => {
                //  console.log(resData)
                if (resData.EC == 0) {
...
module.exports = decorators(TableMix);
