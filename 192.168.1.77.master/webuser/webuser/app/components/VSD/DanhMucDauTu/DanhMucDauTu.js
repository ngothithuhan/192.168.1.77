...
import TableSold from './Components/TableSold'
import TableHaveSymbol from './Components/TableHaveSymbol'
import TableMix from './Components/TableMix'
import TableExpectedSell from './Components/TableExpectedSell';
...
import './DanhMucDauTu.scss'


class DanhMucDauTu extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pagesize: "5",
    ...
    componentDidMount() {
        ...
        if (element && isCustom === true) {
            element.classList.add('danh-muc-dau-tu-customize-body');
        }
        ...
        if (isCustom) {
            ...
            if (this.props.isAccountOverview && this.props.p_custodycd) {
                let e = { value: this.props.p_custodycd, label: '' }
                this.onChangeCUSTODYCD(e)
            } else {
                this.state.keySearch.p_codeid = 'EMPTY';
                this.state.keySearch.p_language = this.props.lang
                this.setState({
    ...
    componentWillUnmount() {
        let element = document.getElementById('main_body');
        if (element) {
            element.classList.remove('danh-muc-dau-tu-customize-body');
        }
    }
    ...
    render() {
        ...
        let { datapage, isAccountOverview } = this.props
        const { user } = this.props.auth
        ...
        return (
            <div className="danh-muc-dau-tu-container">
                ...
                <div className="danh-muc-dau-tu-body">
                    {isAccountOverview !== true && !isCustom && !this.state.isExpectedSellTabActive &&
                        <div className="col-md-12 danh-muc-dau-tu-search">
                            <div className='col-md-6'>
                                <LabelEx className="danh-muc-dau-tu-title"
                                    text={this.props.strings.titlepage} />
                            </div>
                            ...
                            <div className="col-xs-1" style={{ paddingLeft: "0px" }}>
                                <input style={{ margin: "0 0 0 0", maxHeight: "28px" }} type="button" onClick={this.handleClickSearch.bind(this)}
                                    ...
                                    defaultValue={this.props.strings.searchfullname} id="btupdate22" />
                            </div>
                        </div>
                    }
                    ...
                    <div className="danh-muc-dau-tu-content">
                        <ul className="nav nav-tabs sub-nav-dmdt">
                            <li className="active"
                                onClick={this.setExpectedSellTab.bind(this, false)}>
                        ...
                        <div
                            ...
                            <div id="tab2" className="tab-pane fade">
                                {/* CCQ đã bán */}
                                <TableSold OBJNAME={datapage.OBJNAME}
                                    keySearch={this.state.keySearch}
                                    showPopupThongTinMonNop={this.showPopupThongTinMonNop.bind(this)} />
                            </div>
                            <div id="tab3" className="tab-pane fade">
                                {/* Tổng hợp */}
                                <TableMix OBJNAME={datapage.OBJNAME}
                                    keySearch={this.state.keySearch}
                                    showPopupThongTinMonNop={this.showPopupThongTinMonNop.bind(this)} />
                            </div>
...
const decorators = flow([
    ...
    translate('DanhMucDauTu')
]);
module.exports = decorators(DanhMucDauTu);