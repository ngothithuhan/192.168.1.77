...
import TableDongSoLenh from './components/TableDongSoLenh.js'
import ModalDongSoLenh from './components/ModalDongSoLenh.js'

class DongSoLenh extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableDongSoLenh OBJNAME={datapage.OBJNAME} datapage={datapage}
                        showModalDetail={this.showModalDetail.bind(this)}
                    />
                    <ModalDongSoLenh createSuccess={this.createSuccess.bind(this)}
...
const decorators = flow([
    ...
    translate('DongSoLenh')
]);

module.exports = decorators(DongSoLenh);
