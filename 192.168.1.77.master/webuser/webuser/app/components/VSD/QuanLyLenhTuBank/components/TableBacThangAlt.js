...
class TableBacThangAlt extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    componentWillMount() {
        console.log('this.props.dataEDIT:',this.props.dataEDIT)
   ...
   //console.log(nextProps.access)
   // if(nextProps.access=="add"){
      
       this.setState({dataTest:nextProps.dataBT})
   // }
    }
    render() {
                ...
                <div className="container panel panel-success" style={{width: "94%",padding:40,float:"left",paddingTop:10,paddingBottom:10}}>
                    <ReactTable
                        columns={[
                            ...
                            {
                                Header: props => <div className="wordwrap">{this.props.strings.fromvalue}</div>,
                                id: "fromvalue",
                                accessor: "fromvalue",
                                width: 130,
                                Cell : ({value}) =>(
                            ...
                            {
                                Header: props => <div className="wordwrap">{this.props.strings.tovalue}</div>,
                                id: "tovalue",
                                accessor: "tovalue",
                                width: 130,
                                Cell : ({value}) =>(
...
TableBacThangAlt.defaultProps = {
  ...
  const decorators = flow([
    ...
    translate('TableBacThangAlt')
  ]);

  module.exports = decorators(TableBacThangAlt);
