...
import ModalInUyNhiemChi from './components/ModalInUyNhiemChi'
import TableInUyNhiemChi from './components/TableInUyNhiemChi'
import { connect } from 'react-redux'
class InUyNhiemChi extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('InUyNhiemChi')
]);
module.exports = decorators(InUyNhiemChi);
