...
class TableTruyVanThongTinSoDu extends Component {
    constructor(props) {
        super(props);
        this.state = {
            //saleid: 'ALL',
    ...
    async loadDataSoDu(pagesize, page, keySearch, sortSearch) {
        ...
        CUSTODYCD = this.state.CUSTODYCD.value
        if (CUSTODYCD != '') {
            RestfulUtils.post('/fund/getSoDuCCQ', { OBJNAME: this.props.OBJNAME, language: this.props.language, custodycd: CUSTODYCD, pagesize, page, keySearch, sortSearch }).then((resData) => {
                if (resData.EC == 0) {
                    ...
                    <div>
                        ...
                        <div className="col-md-11 row module">
                            ...
                            <Collapse in={this.state.collapse["tienkhadung"]}>
                                <div className="col-md-8 customize-react-table" >
                                    <ReactTable
                                        columns={
                                            [
                                                {
...
const decorators = flow([
    ...
    translate('TableTruyVanThongTinSoDu'),

]);
module.exports = decorators(TableTruyVanThongTinSoDu);
