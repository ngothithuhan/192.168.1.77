...
class ModalDetailCapnhatTrangthaiLenhmuaDaTT_info extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            if (nextProps.isClear) {
                ...
                this.setState({
                    ...
                    symbolsw: nextProps.DATA.SWSYMBOL,
                })
            }
        }
                        ...
                        <div className="add-info-account">
                            <div className={this.state.access == 'view' ? "col-md-12 disable" : "col-md-12"} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-3">
                                        <NumberInput disabled={displayy} className="form-control" value={this.state["amount"]} displayType={'text'} thousandSeparator={true} id="lblAmount" />
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-9 ">
                                        <DropdownFactory disabled={displayy} onSetDefaultValue={this.onSetDefaultValue} CDVAL={this.state.datagroup.p_nstatus} value="p_nstatus" CDTYPE="OD" CDNAME="NORSTATUS" onChange={this.onChangeDRD.bind(this)} ID="drdMoneystatus" />
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-3">
                                        <label className="form-control" id="lblUser">{this.state["symbolsw"]}</label>
...
const decorators = flow([
    ...
    translate('ModalDetailCapnhatTrangthaiLenhmuaDaTT_info')
]);
module.exports = decorators(ModalDetailCapnhatTrangthaiLenhmuaDaTT_info);
