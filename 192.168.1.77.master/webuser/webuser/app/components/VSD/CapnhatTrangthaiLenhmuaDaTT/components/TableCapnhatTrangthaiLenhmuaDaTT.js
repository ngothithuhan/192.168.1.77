...
class TableCapnhatTrangthaiLenhmuaDaTT extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/fund/getlistorder4changerstatus', { data }).then((resData) => {
                ...
                <div className="col-md-12" >
                    <ReactTable
                        columns={[
                            ...
                            {
                                Header: props => <div className="wordwrap">{this.props.strings.EXECTYPE_DESC}</div>,
                                //   id: "EXECTYPE_DESC",
                            ...
                            {
                                Header: props => <div className="wordwrap">{this.props.strings.STATUS_DES}</div>,
                                //   id: "STATUS_DES",
                                //   accessor: "STATUS_DES",
                                id: "STATUS_DES",
                                accessor: "STATUS_DES",
...
TableCapnhatTrangthaiLenhmuaDaTT.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableCapnhatTrangthaiLenhmuaDaTT')
]);

module.exports = decorators(TableCapnhatTrangthaiLenhmuaDaTT);
