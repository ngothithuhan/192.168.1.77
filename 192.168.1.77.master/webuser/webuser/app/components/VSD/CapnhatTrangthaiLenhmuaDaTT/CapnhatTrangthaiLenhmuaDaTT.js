...
import TableCapnhatTrangthaiLenhmuaDaTT from './components/TableCapnhatTrangthaiLenhmuaDaTT'
import ModalDetailCapnhatTrangthaiLenhmuaDaTT_info from './components/ModalDetailCapnhatTrangthaiLenhmuaDaTT_info'

class CapnhatTrangthaiLenhmuaDaTT extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return(
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableCapnhatTrangthaiLenhmuaDaTT  datapage={datapage}
                                        showModalDetail={this.showModalDetail.bind(this)} 
                                        loadgrid={this.state.loadgrid} 
                                        OBJNAME={datapage.OBJNAME}
                                        />
                </div>
                <ModalDetailCapnhatTrangthaiLenhmuaDaTT_info load={this.load.bind(this)}
...
const stateToProps = state => ({
  ...
  const decorators = flow([
    ...
    translate('CapnhatTrangthaiLenhmuaDaTT')
  ]);

  module.exports = decorators(CapnhatTrangthaiLenhmuaDaTT);
