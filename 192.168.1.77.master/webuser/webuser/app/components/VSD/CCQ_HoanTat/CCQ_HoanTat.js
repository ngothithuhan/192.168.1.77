...
import TableCloseSuccessCCQ from './components/TableCloseSuccessCCQ'
import ModalDetailCCQ_Close_Success from './components/ModalDetailCCQ_Close_Success'

class CCQ_HoanTat extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
const decorators = flow([
    ...
    translate('CCQ_HoanTat')
]);

module.exports = decorators(CCQ_HoanTat);
