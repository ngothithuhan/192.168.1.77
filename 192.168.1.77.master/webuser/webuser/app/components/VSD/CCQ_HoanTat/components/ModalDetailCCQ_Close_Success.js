...
class ModalDetailCCQ_Close_Success extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    async submitGroup() {
        var api = '/account/accept_close_account';
...
const decorators = flow([
    ...
    translate('ModalDetailCCQ_Close_Success')
]);
module.exports = decorators(ModalDetailCCQ_Close_Success);
