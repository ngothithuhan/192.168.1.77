...
class TableCloseSuccessCCQ extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            RestfulUtils.posttrans('/account/getlistaccept_close_account', { data }).then((resData) => {
...
TableCloseSuccessCCQ.defaultProps = {
...
const decorators = flow([
    ...
    translate('TableCloseSuccessCCQ')
]);

module.exports = decorators(TableCloseSuccessCCQ);
