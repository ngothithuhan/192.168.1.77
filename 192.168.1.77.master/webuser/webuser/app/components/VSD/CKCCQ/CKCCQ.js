...
import TableCKCCQ from './components/TableCKCCQ'
import ModalDetailCKCCQ_info from './components/ModalDetailCKCCQ_info'

class CKCCQ extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
module.exports = decorators(CKCCQ);
