...
class TableSoldNAV extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    search(keySearch) {
        ...
        RestfulUtils.post('/fund/getlisportfolioexpectnav', { keySearch, type: '1', OBJNAME: this.props.OBJNAME })
            .then(resData => {
...
const decorators = flow([
    ...
    translate('TableSoldNAV')
]);

module.exports = decorators(TableSoldNAV);
