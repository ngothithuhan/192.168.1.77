...
class TableHaveSymbolNAV extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    search(keySearch) {
        let self = this
        RestfulUtils.post('/fund/getlisportfolioexpectnav', { keySearch, type: '2', OBJNAME: this.props.OBJNAME })
            .then(resData => {
                if (resData.EC == 0) {
...
const decorators = flow([
    ...
    translate('TableHaveSymbolNAV')
]);

module.exports = decorators(TableHaveSymbolNAV);
