...
class ModalDetailRE001_info extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            checkFields: [
                ...
                { name: "p_branchid", id: "txtbranchid" },
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            ...
            if (nextProps.isClear) {
                ...
                this.setState({
                    ...
                    p_branchid: nextProps.DATA.BRANCHID,
                    ...
                    GROUPTHRESHOLD: nextProps.DATA.GROUPTHRESHOLD,
                    pv_objname: this.props.OBJNAME,
                    pv_language: this.props.language,
                    p_isSaleOfSelf: nextProps.DATA.ISSALESOFSELF,
    ...
    checkValid(name, id) {
        ...
        switch (name) {
            ...
            case "p_fullname":
                ...
                case "p_branchid":
                if (value == '' || value == null) {
                    mssgerr = this.props.strings.requiredbranchid;
                }
                break;
            case "p_managerid":
                if (value == '') {
    ...
    async submitGroup() {
        ...
        if (mssgerr == '') {
            ...
            let self = this
            console.log('p_prgrpid',this.state.p_prgrpid);
            RestfulUtils.post(api, {
                ...
                branchid: this.state.p_branchid,
                // rateamt: this.state.p_rateamt,
                ratecomm: this.state.p_ratecomm,
                issalesofself: this.state.p_isSaleOfSelf,
    ...
    onchange(event){
        this.setState({ p_isSaleOfSelf:event.target.value});
    }

    render() {
        console.log('p_prgrpid ew',this.state.p_prgrpid);
        // console.log('this.state.p_isSaleOfSelf',this.state.p_isSaleOfSelf)
                            ...
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className="highlight"><b>{this.props.strings.grllevel}</b></h5>
                                    </div>
                                    <div className="col-md-8 customSelect">
                                        <DropdownFactory disabled={disableWhenView || disableWhenUpdate} onSetDefaultValue={this.onSetDefaultValue.bind(this)} CDVAL={this.state.p_grllevel} onChange={this.onChangeDropdown.bind(this)} value="p_grllevel" CDTYPE="SA" CDNAME={"MAXREGRPLEVEL"} ID="drdgrllevel" />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className="highlight"><b>{this.props.strings.branchid}</b></h5>
                                    </div>
                                    <div className="col-md-8 ">
                                        <input maxLength='100' placeholder={this.props.strings.branchid} value={this.state.p_branchid} onChange={this.onChange.bind(this, "p_branchid")} className="form-control" id="txtbranchid" disabled={disableWhenView} />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4 ">
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className="highlight"><b>{this.props.strings.dinhmucnhom}</b></h5>
                                    </div>
                                    <div className="col-md-8">
                                        <NumberFormat disabled={disableWhenView} thousandSeparator={true} decimalScale={0} allowNegative = {false} className="form-control" value={this.state.GROUPTHRESHOLD ? this.state.GROUPTHRESHOLD : '0'} id="txtthreshold" onValueChange={this.onValueChange.bind(this, 'GROUPTHRESHOLD')} prefix={''} placeholder={this.props.strings.GROUPTHRESHOLD} />
                                    </div>
                                    {/* <div className="col-md-8">
                                ...
                                {/* <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className="highlight"><b>{this.props.strings.isSaleOfSelf}</b></h5>
                                    </div>
                                    <div className="col-md-8 customSelect">
                                        <select className="form-control" 
                                        onChange={this.onchange.bind(this)}
                                        value={this.state.p_isSaleOfSelf} 
                                        id="s_isSaleOfSelf">
...
const decorators = flow([
    ...
    translate('ModalDetailRE001_info')
]);
module.exports = decorators(ModalDetailRE001_info);
