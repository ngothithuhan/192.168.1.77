...
import ModalDetailRE001_info from './components/ModalDetailRE001_info'
import TableRE001 from './components/TableRE001'
import { connect } from 'react-redux'
class RE001 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
module.exports = decorators(RE001);
