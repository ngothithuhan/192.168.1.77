...
class ModalDetailQuanLyBieuPhi_info extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            datagroup: {
                ...
                p_feetype: '001',
                p_exectype: 'NR',
                //p_buyfromdate:'01/01/0001',
                //p_buytodate : '01/01/0001',
                p_timetype: '1',
                p_calcfee: ''
            },
            tierdata: '',
            ...
            checkFields: [
                ...
                { name: "p_feeid", id: "drdPRODUCTID" },
                { name: "p_percenttrailerfee", id: "txtPercenttrailerfee" },
                { name: "p_trailerfeededuct", id: "txtTrailerfeededuct" }
            ],
            listProducts: [],
    ...
    onChange(type, event) {
        ...
        if (type == 'p_fundcode') {
            ...
            this.getOptionsPRODUCTByCodeid(event.value);
        }
        if (type == 'p_feeid') {
            this.state.datagroup.p_feeid = event.value;
            this.state.PRODUCTID = event;
        }
        if (type == 'p_object') {
            //this.state.datagroup.p_object = {value : event.value ,label : event.label};
            ...
            if (nextProps.isClear) {
                ...
                this.setState({
                    ...
                    datagroup: {
                        ...
                        p_calcfee: nextProps.DATA.CALCFEE,
                        p_percenttrailerfee: nextProps.DATA.PERCENTTRAILERFEE,
                        p_feeid: nextProps.DATA.FEEID,
                    },
                    PRODUCTID: { value: nextProps.DATA.FEEID, label: nextProps.DATA.FEEID + ' - ' + nextProps.DATA.SPNAME },
                    allcode: nextProps.DATA.FEETYPECD == '001' ? nextProps.DATA.EXECTYPECODE == 'NR' ? 'SASRTYPE' : 'SASRTYPE2' : 'METHODS',
                })
            }
        }
        else
    ...
    checkValid(name, id) {
        ...
        switch (name) {
            ...
            case "p_feename":
                ...
                break;
            case "p_vsdfeeid":
                if (this.state.datagroup.p_feetype != '002') {
                    if (value == '') {
            ...
            case "p_buytodate":
                ...
                break;
            case "p_feerate":
                if (this.state.datagroup.p_ruletype != "T" && this.state.datagroup.p_calcfee != "3") {
            ...
            case "p_percenttrailerfee":
                if (this.state.datagroup.p_feetype == "002" && this.state.datagroup.p_calcfee == "3") {
                    if (value == '') {
                        mssgerr = this.props.strings.requiredpercenttrailerfee;
                    } else {
            ...
            case "p_fundcode":
                ...
                break;
            case "p_feeid":
                if (this.state.datagroup.p_feetype == '001' && this.state.datagroup.p_srtype == 'SP' 
                    && this.state.datagroup.p_feeid == '') {
                    mssgerr = this.props.strings.requireproductid;
                }
                break;
            default:
                break;
    ...
    async submitGroup() {
        ...
        if (mssgerr == '') {
            ...
            console.log('submit:::this.state.datagroup',this.state.datagroup)
        ...
        if (event.target) {
            ...
            if (type == 'p_feetype') {
                if(event.value == '003'){
                    ...
                    allcode = 'METHODS'
                    this.state.datagroup.p_srtype ='FLX';
                } else if (event.value == '001') {
                    this.state.datagroup.p_exectype = 'NR';
                    allcode = 'SASRTYPE';
                    this.state.datagroup.p_srtype ='NN';
                }
          ...
          .then((res) => {
            ...
            if (res.DT.data && res.DT.data.length > 0) {
                res.DT.data.forEach(item => {
                    ...
                    item.label = item.VSDSPCODE + ' - ' + item.SPNAME;
                        ...
                        <div className="add-info-account">
                            ...
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    {this.state.datagroup.p_feetype == '001' || this.state.datagroup.p_feetype == '002' || this.state.datagroup.p_feetype == '004' ?
                                        <div className="col-md-6">
                                            <div className="col-md-4">
                                ...
                                <div className="col-md-12 row">
                                    {this.state.datagroup.p_feetype == '002' ?
                                        <div className="col-md-6">
                                            <div className="col-md-4">
                                                <h5 className="highlight"><b>{this.props.strings.calcfee}</b></h5>
                                            </div>
                                            <div className="col-md-8 ">
                                                <DropdownFactory disabled={displaydisablednew} CDVAL={this.state.datagroup["p_calcfee"]} onSetDefaultValue={this.onSetDefaultValue} onChange={this.onChangeDRD.bind(this)} value="p_calcfee" CDTYPE="SY" CDNAME="CALCFEE" ID="drdCalcfee" />
                                            </div>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    {this.state.datagroup.p_feetype == '001' && this.state.datagroup.p_exectype == 'NR' ?
                                        <div className="col-md-6">
                                            <div className="col-md-4">
                                                <h5 className="highlight"><b>{this.props.strings.ordertype}</b></h5>
                                            </div>
                                            <div className="col-md-8 ">
                                                <DropdownFactory disabled={displaydisablednew} CDVAL={this.state.datagroup["p_srtype"]} onSetDefaultValue={this.onSetDefaultValue} onChange={this.onChangeDRD.bind(this)} value="p_srtype" CDTYPE="SA" CDNAME= {allcode} ID="drd_p_srtype" />
                                    ...
                                    {this.state.datagroup.p_feetype == '004' ?
                                        <div className="col-md-6">
                                            <div className="col-md-4">
                                                <h5 className="highlight"><b>{this.props.strings.ordertype}</b></h5>
                                            </div>
                                ...
                                {this.state.datagroup.p_feetype == '001' && this.state.datagroup.p_srtype == 'SP' && (
                                    <div className="col-md-12 row">
                                        <div className="col-md-6"></div>
                                        <div className="col-md-6">
                                            <div className="col-md-4">
                                                <h5 className="highlight"><b>{this.props.strings.productid}</b></h5>
                                            </div>
                                            <div className="col-md-8">
                                                <Select
                                                    name="form-field-name"
                                                    disabled={displaydisablednew}
                                                    placeholder={this.props.strings.productid}
                                                    options={this.state.listProducts}
                                                    value={this.state.PRODUCTID}
                                                    onChange={this.onChange.bind(this, "p_feeid")}
                                                    id="drdPRODUCTID"
                                                />
                                            </div>
                                        </div>
                                ...
                                {this.state.datagroup.p_feetype == '002' && this.state.datagroup.p_calcfee == '3' ? 
                                    <div className="col-md-12 row">
                                        <div className="col-md-6">
                                            <div className="col-md-4">
                                                <h5 className="highlight"><b>{this.props.strings.percenttrailerfee}</b></h5>
                                            </div>
                                            <div className="col-md-8 " >
                                                <NumberFormat maxLength={7} disabled={displaydisabled} decimalScale={4} className="form-control" id="txtPercenttrailerfee" onValueChange={this.onValueChange.bind(this, 'p_percenttrailerfee')} prefix={''} placeholder={this.props.strings.percenttrailerfee} value={this.state.datagroup["p_percenttrailerfee"]} allowNegative={false} />
                                            </div>
                                        </div>
                                    </div>
                                    :
                                    <div className="col-md-12 row">
                                        {this.state.datagroup.p_feetype == '001' && this.state.datagroup.p_exectype == 'NR' && this.state.datagroup.p_srtype == 'SP' ? 
                                            <div className="col-md-6">
                                                <div className="col-md-4">
                                        ...
                                        :null }
                                        {this.state.datagroup.p_feetype == '003' || (this.state.datagroup.p_calcfee != '3' && this.state.datagroup.p_feetype == '002') ? 
                                            <div className="col-md-6">
                                                <div className="col-md-4">
                                                    <h5 className="highlight"><b>{this.props.strings.feestyle}</b></h5>
                                                </div>
                                        ...
                                        {this.state.datagroup.p_feetype == '004' ? 
                                            <div className="col-md-6">
                                                ...
                                                <div className="col-md-8 ">
                                                    <DropdownFactory disabled={true} CDVAL={this.state.datagroup["p_ruletype"]} onSetDefaultValue={this.onSetDefaultValue} onChange={this.onChangeDRD.bind(this)} value="p_ruletype" CDTYPE="SA" CDNAME="RULETYPE" ID="drdFeestyle" />
                                ...
                                <div className="col-md-12 row">
                                    {this.state.datagroup.p_calcfee != '3' ?
                            ...
                            {this.state.datagroup.p_ruletype == 'T' && this.state.datagroup.p_calcfee != '3' ?
                                <TableBacThang showModalDetail={this.showModalDetail.bind(this)}
                                    ...
                                    access={this.state.access}
                                    isPercent={this.state.datagroup.p_feecalc}
                                    isTrailerfee={this.state.datagroup.p_calcfee}
                                    feetype={this.state.datagroup.p_feetype}
                                /> :
                                null
                            }
                            <ModalBacThang
...
const decorators = flow([
    ...
    translate('ModalDetailQuanLyBieuPhi_info')
]);
module.exports = decorators(ModalDetailQuanLyBieuPhi_info);
