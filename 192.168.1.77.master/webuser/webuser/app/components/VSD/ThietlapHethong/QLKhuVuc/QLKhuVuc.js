...
import TableQLKV from './components/TableQLKV'
import ModalDetailQLKV from './components/ModalDetailQLKV'

class QLKhuVuc extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableQLKV OBJNAME={datapage.OBJNAME} datapage={datapage}
...
module.exports = decorators(QLKhuVuc);
