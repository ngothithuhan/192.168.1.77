...
import TableQLToChucNH from './components/TableQLToChucNH'
import ModalDetailQLToChucNH from './components/ModalDetailQLToChucNH'

class QLToChucNH extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
...
const decorators = flow([
    ...
    translate('QLToChucNH')
]);

module.exports = decorators(QLToChucNH);
