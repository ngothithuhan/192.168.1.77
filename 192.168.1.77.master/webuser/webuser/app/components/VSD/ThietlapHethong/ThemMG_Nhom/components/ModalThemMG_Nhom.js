...
class ModalThemMG_Nhom extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ISEDIT: false,
    ...
    async componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            if (nextProps.isClear) {
                // this.props.change()
                await RestfulUtils.post('/user/getretypebysaleid', { saleid: nextProps.DATA.SALEID, language: this.props.language })
                    .then((res) => {
                        var retype = ""
                        if (res.result && res.result.length > 0) {
                            res.result.map(function (event) {
                                if (event.label == nextProps.DATA.RETYPE) {
                                    self.setState({ p_retype: event.value })
                                    console.log("getretypebysaleid", event.value)
                                }
                                return null
                            })
                        }
                        self.setState({
                            ...
                            p_active: nextProps.DATA.ACTIVEDESC,
                            p_saleid: nextProps.DATA.SALEID,
                            p_retypename: nextProps.DATA.RETYPE,
                            label_rerole: nextProps.DATA.ROLENAME,
                        })
    ...
    submitGroup = () => {
        ...
        let success = null;
        var p_saleacctno = this.state.p_saleid + this.state.p_retype;
        let datadelete = {
        ...
        if (this.state.GROUP.value && this.state.GROUP.value != '' && this.state.GROUP.value != undefined) {
            RestfulUtils.post('/user/addsaleidtogroup', datadelete)
                .then(res => {
            ...
            toast.error(this.props.strings.requiredgroup, { position: toast.POSITION.BOTTOM_RIGHT })
        }
    }
                    ...
                    <div className="panel-body ">
                        <div className="add-info-account">
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 className={disableWhenView ? "" : "highlight"} > <b>{this.props.strings.titleNhom}</b></h5>
                                    </div>
                                    <div className="col-md-8">
                                        {disableWhenView ?
                                            <label className="form-control" id="lblGROUP"></label>
                                            : <Select.Async
                                                name="form-field-name"
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5><b>{this.props.strings.retype}</b></h5>
                                    </div>
                                    <div className="col-md-8 customSelect">
                                        {disableWhenView ?
                                            <label className="form-control" id="lblRetype">{this.state.p_retypename}</label>
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-8">
                                        <label className="form-control" id="lblBrname">{this.state.p_brname}</label>
                                    </div>
                                    {/* <div className="col-md-8 customSelect">
                                        <Select.Async className="form-field-name"
                                            disabled={disableWhenView}
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-8">
                                        <label className="form-control" id="lblmbname">{this.state.p_mbname}</label>
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5 ><b>{this.props.strings.active}</b></h5>
                                    </div>
                                    <div className="col-md-8">
                                        <label className="form-control" id="lblmbname">{this.state.p_active}</label>
                                    </div>
                                </div>
                                {/* <div className="col-md-12 row">
                                    <div className="col-md-4">
...
const decorators = flow([
    ...
    translate('ModalThemMG_Nhom')
]);
module.exports = decorators(ModalThemMG_Nhom);
