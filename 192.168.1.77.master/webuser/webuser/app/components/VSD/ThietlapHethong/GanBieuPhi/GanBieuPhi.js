...
import TableGanBieuPhi from './components/TableGanBieuPhi'
import ModalDetailGanBP from './components/ModalDetailGanBP'

class GanBieuPhi extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return(
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableGanBieuPhi OBJNAME={datapage.OBJNAME}  datapage={datapage}
...
const stateToProps = state => ({
  ...
  const decorators = flow([
    ...
    translate('GanBieuPhi')
  ]);

  module.exports = decorators(GanBieuPhi);
