...
import TableLoaiHinhMG from './components/TableLoaiHinhMG'
import { connect } from 'react-redux'
class QLLoaiHinhMG extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
    ...
    return (
      <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
        ...
        <div className="panel-body" >
          <TableLoaiHinhMG datapage={datapage}
            showModalDetail={this.showModalDetail.bind(this)}
            OBJNAME={datapage.OBJNAME}
            loadgrid={this.state.loadgrid} />
          <ModalDetailQLLoaiHinhMG_info createSuccess={this.createSuccess.bind(this)}
...
QLLoaiHinhMG.defaultProps = {

  strings: {
    title: 'Quản lý loại hình môi giới'
...
const decorators = flow([
  ...
  translate('QLLoaiHinhMG')
]);

module.exports = decorators(QLLoaiHinhMG);
