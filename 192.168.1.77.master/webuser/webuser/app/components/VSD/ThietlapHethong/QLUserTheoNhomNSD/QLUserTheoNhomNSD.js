...
import ModalQLUserTheoNhomNSD from './components/ModalQLUserTheoNhomNSD'
import TableQLUserTheoNhomNSD from './components/TableQLUserTheoNhomNSD'
import { connect } from 'react-redux'
class QLUserTheoNhomNSD extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableQLUserTheoNhomNSD OBJNAME={datapage.OBJNAME} datapage={datapage}
                        showModalDetail={this.showModalDetail.bind(this)}
                        loadgrid={this.state.loadgrid} />
                </div>
                <ModalQLUserTheoNhomNSD createSuccess={this.createSuccess.bind(this)}
...
const decorators = flow([
    ...
    translate('QLUserTheoNhomNSD')
]);

module.exports = decorators(QLUserTheoNhomNSD);
