...
import TableAddCreateQLTTSanPham from './components/TableAddCreateQLTTSanPham'
import ModalDetailQLTTSanPham from './components/ModalDetailQLTTSanPham'

class QLThongTinSanPham extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('QLThongTinSanPham')
]);

module.exports = decorators(QLThongTinSanPham);
