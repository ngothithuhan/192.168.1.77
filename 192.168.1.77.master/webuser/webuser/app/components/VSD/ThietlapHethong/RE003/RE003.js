...
import ModalDetailRE003_Info from './components/ModalDetailRE003_Info'
import TableRE003 from './components/TableRE003'
import { connect } from 'react-redux'
class RE003 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableRE003 OBJNAME={datapage.OBJNAME} datapage={datapage}
                        showModalDetail={this.showModalDetail.bind(this)}
                        loadgrid={this.state.loadgrid} />
                </div>
                <ModalDetailRE003_Info createSuccess={this.createSuccess.bind(this)}
...
module.exports = decorators(RE003);
