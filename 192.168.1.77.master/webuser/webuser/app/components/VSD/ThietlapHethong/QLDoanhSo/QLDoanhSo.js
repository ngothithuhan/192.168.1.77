...
// import ModalDetailQLLoaiHinhMG_info from './components/ModalDetailQLLoaiHinhMG_info'
import TableQLDoanhSo from './components/TableQLDoanhSo'
import ModalQLDoanhSo from './components/ModalQLDoanhSo'
import { connect } from 'react-redux'
class QLDoanhSo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
QLDoanhSo.defaultProps = {

  // strings: {
  //   title: 'Quản lý doanh số môi giới'
...
module.exports = decorators(QLDoanhSo);
