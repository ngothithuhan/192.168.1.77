...
import TableRejectCCQ from './components/TableRejectCCQ'
import ModalDetailCCQ_Close_Reject from './components/ModalDetailCCQ_Close_Reject'

class CCQ_Reject extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            collapse: {
    ...
    render() {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <ModalDetailCCQ_Close_Reject createSuccess={this.createSuccess.bind(this)}
...
const decorators = flow([
    ...
    translate('CCQ_Reject')
]);

module.exports = decorators(CCQ_Reject);
