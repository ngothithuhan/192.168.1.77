...
import TableChuyenNhomCareByKH from './components/TableChuyenNhomCareByKH'
import ModalDetailChuyenNhomCareByKH from './components/ModalDetailChuyenNhomCareByKH'

class ChuyenNhomCareByKH extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableChuyenNhomCareByKH datapage={datapage}
...
const decorators = flow([
    ...
    translate('ChuyenNhomCareByKH')
]);

module.exports = decorators(ChuyenNhomCareByKH);
