...
import TableQuanLyLenhSipDaSua from './components/TableQuanLyLenhSipDaSua'
// import ModalQuanLyLenhSipDaSua from './components/ModalQuanLyLenhSipDaSua'
import { connect } from 'react-redux'
class QuanLyLenhSipDaSua extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('QuanLyLenhSipDaSua')
]);
module.exports = decorators(QuanLyLenhSipDaSua);
