...
import TableXacNhanLenhDatHo from './components/TableXacNhanLenhDatHo'
import ModalXacNhanLenhDatHo from './components/ModalXacNhanLenhDatHo'
import { connect } from 'react-redux'
class XacNhanLenhDatHo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('XacNhanLenhDatHo')
]);
module.exports = decorators(XacNhanLenhDatHo);
