...
class ModalXacNhanLenhDatHo extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    async submitGroup() {
        var api = '/vcbf/submitconfirmorder';
        ...
        let { p_orderid, p_custodycd, p_codeid, p_fullname, p_qtty, p_amount, p_dealtype } = this.state
        RestfulUtils.posttrans(api, {
            p_orderid, p_custodycd, p_codeid, p_fullname, p_qtty, p_amount, p_dealtype,
                    ...
                    <div className="panel-body ">
                        <div className="add-info-account">
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5><b>{this.props.strings.soluong}</b></h5>
                                    </div>
                                    <div className="col-md-8 ">
                                        <NumberFormat className="form-control" value={this.state.p_qtty} displayType={'text'} thousandSeparator={true} decimalScale={2} />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                ...
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                        <h5><b>{this.props.strings.maccqhoandoi}</b></h5>
                                    </div>
                                    <div className="col-md-8 ">
                                        <label className="form-control">{this.state.p_swsymbol}</label>
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
...
const decorators = flow([
    ...
    translate('ModalXacNhanLenhDatHo')
]);
module.exports = decorators(ModalXacNhanLenhDatHo);
