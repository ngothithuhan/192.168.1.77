...
import TableXNTraTienThua from './components/TableXNTraTienThua'
import ModalDetailXNTraTienThua from './components/ModalDetailXNTraTienThua'

class XNTraTienThua extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableXNTraTienThua datapage={datapage}
...
const decorators = flow([
    ...
    translate('XNTraTienThua')
]);

module.exports = decorators(XNTraTienThua);
