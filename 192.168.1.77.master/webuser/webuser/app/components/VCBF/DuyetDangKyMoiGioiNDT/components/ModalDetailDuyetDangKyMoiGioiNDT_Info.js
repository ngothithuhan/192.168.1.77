...
class ModalDetailDuyetDangKyMoiGioiNDT_Info extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ISEDIT: false,
    ...
    async componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            ...
            if (nextProps.isClear) {
                this.props.change()
                await RestfulUtils.post('/fund/get_list_customer_reg_changesale',  { pagesize: this.state.pagesize, language: this.props.language , OBJNAME: this.props.OBJNAME }).then((resData) => {
                    if (resData.EC == 0) {
                        this.setState({ optionsDataMG: resData.DT.data})
                    } else {
                ...
                await RestfulUtils.post('/user/getretypebysaleid', { saleid: nextProps.DATA.SALEID_NEW, language: this.props.language })
                    .then((res) => {
    ...
    async delete() {
        ...
        if (mssgerr == '') {
            ...
            RestfulUtils.posttrans(api, {
                ...
                // rerole: this.state.p_rerole, 
                // reproduct: this.state.p_reproduct, 
    ...
    render() {
        console.log('optionsDataMG :', this.state.optionsDataMG)
        console.log('dataMG :', this.state.dataMG)
                            ...
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                                <div className="col-md-12 row">
                                    ...
                                    {/* <div className="col-md-8">
                                        <label className="form-control" id="lblFullname">{this.state.CUSTODYCD}</label>
                                    </div> */}
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    {/* <div className="col-md-8">
                                        <label className="form-control" id="lblFullname">{this.state.p_saleid}</label>
                                    </div> */}
                                    <div className="col-md-8">
                                        <label className="form-control" id="lblSaleid">{this.state.p_saleid + ' - ' + this.state.p_tlname}</label>
                                    </div>
                                    {/* <div className="col-md-8 customSelect">
                                ...
                                <div className="col-md-12 row">
                                    <div className="pull-right">
                                        {/* <input disabled={disableWhenView} onClick={this.delete.bind(this)} type="button" className="btn btn-primary" style={{ marginRight: 15 }} value={this.props.strings.delete} id="btnDelete" /> */}
...
const decorators = flow([
    ...
    translate('ModalDetailDuyetDangKyMoiGioiNDT_Info')
]);
module.exports = decorators(ModalDetailDuyetDangKyMoiGioiNDT_Info);
