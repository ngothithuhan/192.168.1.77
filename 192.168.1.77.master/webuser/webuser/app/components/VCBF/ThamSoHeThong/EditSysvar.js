...
import ModalEditSysvar from './components/ModalEditSysvar'
import TableEditSysvar from './components/TableEditSysvar'
import { connect } from 'react-redux'
class EditSysvar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('EditSysvar')
]);
module.exports = decorators(EditSysvar);
