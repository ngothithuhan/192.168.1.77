...
import TablePhongToaCCQ from './components/TablePhongToaCCQ'
import ModalPhongToaCCQ from './components/ModalPhongToaCCQ'
import { connect } from 'react-redux'
class PhongToaCCQ extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('PhongToaCCQ')
]);
module.exports = decorators(PhongToaCCQ);
