...
class ModalPhongToaCCQ extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        if (nextProps.access == "update" || nextProps.access == "view") {
            if (nextProps.isClear) {
                ...
                this.setState({
                    ...
                    p_avlqtty: nextProps.DATA.AVLQTTY,
                    p_avlsqtty: nextProps.DATA.AVLQTTYSIP,
                    p_nqtty: nextProps.DATA.NQTTY? this.state.p_nqtty: '',
                    p_sqtty: nextProps.DATA.SQTTY? this.state.p_sqtty: '',
    ...
    async submitGroup() {
        ...
        if (mssgerr == '') {
            var api = '/balance/actionblockccq';
            var { dispatch } = this.props;
            var datanotify = {
                type: "",
                header: "",
                            ...
                            <div className={this.state.access == "view" ? "col-md-12 disable" : "col-md-12 "} style={{ paddingTop: "11px" }}>
                               ...
                               <div className="col-md-12 row">
                                ...
                                <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-8">
                                        <NumberFormat thousandSeparator={true} disabled={disableWhenView} className="form-control" decimalScale={2} value={this.state.p_nqtty} id="txtnqtty" onValueChange={this.onValueChange.bind(this, 'p_nqtty')} prefix={''} placeholder={this.props.strings.thuongphongtoa} />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-8">
                                        <NumberFormat thousandSeparator={true} disabled={disableWhenView} className="form-control" decimalScale={2} value={this.state.p_sqtty} id="txtsqtty" onValueChange={this.onValueChange.bind(this, 'p_sqtty')} prefix={''} placeholder={this.props.strings.sipphongtoa} />
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-4">
...
const decorators = flow([
    ...
    translate('ModalPhongToaCCQ')
]);
module.exports = decorators(ModalPhongToaCCQ);
