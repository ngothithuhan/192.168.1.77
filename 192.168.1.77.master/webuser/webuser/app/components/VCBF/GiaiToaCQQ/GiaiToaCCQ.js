...
import TableGiaiToaCCQ from './components/TableGiaiToaCCQ'
import ModalGiaiToaCCQ from './components/ModalGiaiToaCCQ'
import { connect } from 'react-redux'
class GiaiToaCCQ extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      collapse: {
...
const decorators = flow([
  ...
  translate('GiaiToaCCQ')
]);
module.exports = decorators(GiaiToaCCQ);
