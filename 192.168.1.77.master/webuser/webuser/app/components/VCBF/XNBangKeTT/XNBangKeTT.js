...
import TableXNBangKeTT from './components/TableXNBangKeTT'
import ModalDetailXNBangKeTT from './components/ModalDetailXNBangKeTT'

class XNBangKeTT extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableXNBangKeTT datapage={datapage}
...
const decorators = flow([
    ...
    translate('XNBangKeTT')
]);

module.exports = decorators(XNBangKeTT);
