...
class TableXNBangKeTT extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    fetchData(state, instance) {
        ...
        if (this.state.firstRender) {
            ...
            if (data.p_codeid != '') {
                RestfulUtils.posttrans('/vcbf/getlisteciving_sell_money_confirm', { data }).then((resData) => {
            ...
            this.state.selectedRows.forEach((key, value, set) => {
                ...
                new Promise((resolve, reject) => {
                    ...
                    if (data && data.length > 0) {
                        ...
                        resolve(RestfulUtils.posttrans('/vcbf/sr_reciving_sell_money', datasubmit)
                            .then(res => {
                                i += 1
    ...
    render() {
        ...
        return (
            <div>
                ...
                {/* <div style={{ marginLeft: "-41px" }} className="col-md-3 ">
                     </div> */}
            </div>
            <div className="col-md-12" >
                <ReactTable
                    columns={[
                        ...
                        {
                            Header: props => <div className="wordwrap" id="lblSESSIONNO">{this.props.strings.SESSIONNO}</div>,
                            id: "SESSIONNO",
                            accessor: "SESSIONNO",
                            width: 100,
                            Cell: ({ value }) => (
...
const decorators = flow([connect(stateToProps), translate("TableXNBangKeTT")]);

module.exports = decorators(TableXNBangKeTT);
