...
class ModalDetailXNBangKeTT extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <div className="panel-body ">
                        <div className="add-info-account">
                            ...
                            <div className="col-md-12 row">
                                    ...
                                    <div className="col-md-3">
                                        <label className="form-control" id="lblTXDATE">{this.state.datagroup["p_txdate"]}</label>
                                    </div>
                                </div>
                                <div className="col-md-12 row">
                                    <div className="col-md-3">
...
const decorators = flow([
    ...
    translate('ModalDetailXNBangKeTT')
]);

module.exports = decorators(ModalDetailXNBangKeTT);
