...
import TableTraTienThua from './components/TableTraTienThua'
import ModalDetailTraTienThua from './components/ModalDetailTraTienThua'

class TraTienThua extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div style={{ borderColor: "rgba(123, 102, 102, 0.43)", padding: "10px" }} className="container panel panel-success margintopNewUI">
                ...
                <div className="panel-body" >
                    <TableTraTienThua datapage={datapage}
...
const decorators = flow([
    ...
    translate('TraTienThua')
]);

module.exports = decorators(TraTienThua);
